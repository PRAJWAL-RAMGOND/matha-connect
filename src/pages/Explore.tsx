...
const sections = [
  { icon: Users, label: "Guru Parampara", desc: "History & lineage of the Matha", color: "bg-gradient-maroon" },
  { icon: Image, label: "Gallery", desc: "Photos & videos from events", color: "bg-gradient-saffron" },
  { icon: Scroll, label: "Publications", desc: "Pravachana, books & references", color: "bg-gradient-maroon" },
  { icon: MapPin, label: "Branches", desc: "Find Matha branches near you", color: "bg-gradient-saffron" },
  { icon: Trophy, label: "Youth Quiz", desc: "Test your knowledge of Siddhanta", color: "bg-gradient-maroon" },
  { icon: BookOpen, label: "Panchanga", desc: "Tithinirnaya Panchanga", color: "bg-gradient-saffron" },
];
